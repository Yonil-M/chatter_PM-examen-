...
import '../widget/glowing_action_buttom.dart';
...
/// widget para mostrar la lista actual de usuaios que escriben 
class TypingIndicator extends StatelessWidget {
  /// Instanciar un nuevo TypingIndicador(Indicador de escritura)
  const TypingIndicator({
    Key? key,
    this.alternativeWidget,
  }) : super(key: key);

  /// Widget creado cuando no se esta escribiendo
...
/// Widget que se crea a sí mismo en función de la última instantánea de interacción con
/// una [Stream] de tipo [ConnectionStatus].
///
/// El widget usará el más cercano [StreamChatClient.wsConnectionStatusStream]
/// en caso de que no se proporcione flujo.
class ConnectionStatusBuilder extends StatelessWidget {
  /// Crea un nuevo ConnectionStatusBuilder(Generador de estado de conexion)
  ...
  /// El cálculo asíncrono al que está conectado actualmente este constructor.
  final Stream<ConnectionStatus>? connectionStatusStream;

  /// El constructor que se utilizará en caso de error.
  final Widget Function(BuildContext context, Object? error)? errorBuilder;

  /// El constructor que se utilizará en caso de carga.
  final WidgetBuilder? loadingBuilder;

  /// El constructor que se utilizará en caso de datos.
